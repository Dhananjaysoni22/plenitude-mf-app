...
import { getClients, getResearchFunds, getRawResearchFundsController, getClientById, getUnmappedFunds, mapFund, getStats, getClientHistory, getDrawdownData, exportClientExcel } from '../controllers/data.controller';
...
router.post('/clients/:id/export', authenticate, exportClientExcel);
